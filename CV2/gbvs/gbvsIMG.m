function [out,motionInfo] = gbvs(img,param,prevMotionInfo,percorso)
...
[rawfeatmaps motionInfo] = getFeatureMaps( img , param , prevMotionInfo,percorso );
...
for fmapi = 1 : length(mapnames)
    mymessage(param,'adding in %s map with weight %g\n', map_types{fmapi}, mapweights(fmapi) );
