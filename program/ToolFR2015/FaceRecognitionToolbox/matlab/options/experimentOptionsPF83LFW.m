...
% Dataset Parameters
opt.dataset.featurePath = 'ENTER FEATURE DIRECTORY HERE';
opt.dataset.identities = 83;
opt.dataset.repetitions = 1;
opt.dataset.name = 'pf83lfw_hog_gabor_lbp'; % Designator for dataset (i.e. fbdataset, pubfig, etc)

% Output Parameters
opt.results.path = 'ENTER RESULTS DIRECTORY HERE';
opt.results.name = 'pf83lfw';
