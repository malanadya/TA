%IM2OBJ Convert Matlab image to PRTools dataset object
%
%	A = im2obj(image,A)
%
% This adds a standard Matlab image as an object to an existing
% dataset A. If A is not given a new dataset is created.
%
% uint8 images are converted to doubles and divided by 256.
%
% See datasets, im2feat, data2im
