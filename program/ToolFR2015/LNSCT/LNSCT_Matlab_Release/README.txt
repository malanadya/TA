LNSCT Toolbox (July 2010)

Autjor:

Xiaohua Xie, sysuxiexh@gmail.com

Please refer the file "Demos_LNSCT.m" for detailed usage of LNSCT for feature extraction.
...
References: 
X.Xie,etal.,Extraction of illumination invariant facial features froma single image using nonsubsampled contourlet transform,Pattern Recognition(2010),doi:10.1016/j.patcog.2010.06.019




In addition, see the details of Nonsubsampled Contourlet Toolbox as following:
