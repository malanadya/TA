function y = vec2nsct(c, s)
% VEC2NSCT   Convert the vector form to the output structure of the NSCT
%
%       y = vec2nsct(c, s)
%
% Input:
%   c:  1-D vector that contains all NSCT coefficients
%   s:  structure of NSCT output
%
% Output:
%   y:  NSCT coefficients in cell vector format that can be used in pdfbrec
%
% See also:	NSCT2VEC, PDFBREC
